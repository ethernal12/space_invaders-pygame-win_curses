...
class Test_Bataljon(unittest.TestCase):
    ...
    def test___init__(self):
        ...
        self.assertEqual(self.bataljon.razmik_vesoljcev.x, 0.1)
        self.assertEqual(self.bataljon.razmik_vesoljcev.y, 0.1)
    ...
    def test_premik(self):
        ...
        self.vesolje.bataljon.vesoljci = []
        self.vesolje.bataljon.vesoljci = [Vesoljec(y=1, x=0, sirina=0.1, visina=0.1, hitrost=-0.1)]
        self.vesolje.bataljon.premik()
        self.assertTrue(self.vesolje.bataljon.vesoljci[0].hitrost == 0.1)
